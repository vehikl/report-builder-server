...
class ReportSeeder extends Seeder
{
    public function run(): void
    {
        $redFlagColumns = [
            ...
            ['name' => 'Termed', 'position' => 4, 'expression' => new FieldExpression('is_termed'), 'format' => Format::YesNo->value],
            ...
            ['name' => 'Current Salary', 'position' => 30, 'expression' => new FieldExpression('salary'), 'format' => Format::NumberZeroDecimal->value],
            ...
            ['name' => 'Base Salary % Change', 'position' => 36, 'expression' => new FieldExpression('salary_increase_percent'), 'format' => Format::NumberTwoDecimals->value],
        ];

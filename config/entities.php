...
return [
    ...
    2 => [
        ...
        'fields' => [
            ...
            /*  9 */ ['identifier' => 'total_compensation', 'path' => 'total_compensation', 'name' => 'Total Compensation', 'type' => 'number'],
            /*  9 */ ['identifier' => 'name_with_job', 'path' => 'name_with_job', 'name' => 'Name With Job', 'type' => 'number'],
            /*  9 */ ['identifier' => 'job_title', 'path' => 'job_title', 'name' => 'Job Title', 'type' => 'string'],
